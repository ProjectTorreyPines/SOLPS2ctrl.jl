...
if isempty(ARGS) || "PCS" in ARGS
    @testset "PCS instruction writing" begin
        ...
        d = zeros(1, 1)
        y2x = [[1.321, 1.2, 0.5] [1.22, 1.1, 0.6] [1.2, 1.2, 0.4] [1.1, 1.065, 0.45] [1.09, 1.054, 0.39] [1.293, 1.02, 0.38]]
        u2x = [[0.978, 1.05, 0.43] [1.19, 1.02, 0.7] [1.4, 1.3, 0.2] [0.85, 1.01, 0.55] [0.91, 0.99, 0.25] [0.97, 0.74, 0.21]]
